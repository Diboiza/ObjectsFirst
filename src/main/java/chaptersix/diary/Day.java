...
public class Day {
    //the first and final booking hours of the day
    public static final int START_OF_DAY = 9;
    public static final int END_OF_DAY = 17;
    //the number of bookable hours in a day
    public static final int MAX_BOOKABLE_PER_DAY =
            END_OF_DAY - START_OF_DAY + 1;

    //a day number within a particular year
    private int dayNumber;
    //the list of appointments for this day
    ...
    public Day(int dayNumber)
    {
        ...
        appointments = new Appointment[MAX_BOOKABLE_PER_DAY];
    }
    ...
    public int findSpace(Appointment appointment)
    {
        ...
        for(int slot = 0; slot < MAX_BOOKABLE_PER_DAY; slot++) {
    ...
    {
        return time >= START_OF_DAY && time <= END_OF_DAY;
    }
